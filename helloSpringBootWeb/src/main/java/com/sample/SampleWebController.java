...
// public ModelAndView send(@RequestParam("inputvalue") String inputvalue,
// ModelAndView mv) {
...
// public ModelAndView indexReact(@RequestParam("numInput1") int numInput1,
...
// public ModelAndView mailReg(@RequestParam("mailAddress") String mailAddress,
...
// @PostMapping(value = "/login")
// public ResponseEntity<String> login(@RequestParam("userid") String id,
// @RequestParam("password") String pass) { // ←ポイントです
